...
export default {
    mounted() {
        ...
        gsap.set('#container', {
            position: 'fixed', width: 7900, height: 5600, transformOrigin: '0 0'
        });
        gsap.to('#container', {
            duration: 1, opacity: 1, ease: 'power2.inOut', delay: 0.3
        });

        // tween the svg path + circle
        gsap.timeline({
            scrollTrigger: {
                trigger: '#scrollDist', start: 'top top', end: 'bottom bottom', scrub: 1
            }
        })
